<div class="col-md-12 well">
  ...
  <div class="box-header">
    <div class="col-md-2" style="padding: 0;">
      <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-detail-posisi"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
    </div>
